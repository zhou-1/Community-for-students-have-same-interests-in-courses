...
if __name__ == '__main__':
    ...
    testX = np.array([2,3,3,3,3,3,3])
    k = 10
    outputLabelX = classify0(testX,dataSet,labels,k)
    testY = np.array([0,2,2,3,3,1,1])
    array_in = get_input(username)
    outputLabelY = classify0(array_in,dataSet,labels,k)
    print('input is :',testX,'output class is :',outputLabelX)
    print('input is :',array_in,'output class is :',outputLabelY)